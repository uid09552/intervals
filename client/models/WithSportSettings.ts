...
export type WithSportSettings = {
    ...
    fahrenheit?: boolean;
    wind_speed?: WithSportSettings.wind_speed;
    rain?: WithSportSettings.rain;
    weight?: number;
    email?: string;
    sex?: string;
    city?: string;
    ...
    date_format?: string;
    time_format?: string;
    visibility?: WithSportSettings.visibility;
    icu_last_seen?: string;
    status?: WithSportSettings.status;
    status_updated?: string;
    icu_resting_hr?: number;
    icu_weight?: number;
    icu_weight_sync?: WithSportSettings.icu_weight_sync;
    icu_activated?: string;
    icu_queue_pos?: number;
    icu_admin?: boolean;
    icu_friend_invite_token?: string;
    icu_permission?: WithSportSettings.icu_permission;
    ...
    icu_menstrual_cycle_perm?: WithSportSettings.icu_menstrual_cycle_perm;
    ...
    garmin_power_target?: WithSportSettings.garmin_power_target;
    ...
    height?: number;
    height_units?: WithSportSettings.height_units;
    plan?: WithSportSettings.plan;
    plan_expires?: string;
...
export namespace WithSportSettings {
