...
export type AthleteUpdateDTO = {
    ...
    fahrenheit?: boolean;
    wind_speed?: AthleteUpdateDTO.wind_speed;
    rain?: AthleteUpdateDTO.rain;
    weight?: number;
    email?: string;
    sex?: string;
    city?: string;
    ...
    date_format?: string;
    time_format?: string;
    visibility?: AthleteUpdateDTO.visibility;
    icu_last_seen?: string;
    status?: AthleteUpdateDTO.status;
    status_updated?: string;
    icu_resting_hr?: number;
    icu_weight?: number;
    icu_weight_sync?: AthleteUpdateDTO.icu_weight_sync;
    icu_activated?: string;
    icu_queue_pos?: number;
    icu_admin?: boolean;
    icu_friend_invite_token?: string;
    icu_permission?: AthleteUpdateDTO.icu_permission;
    ...
    icu_menstrual_cycle_perm?: AthleteUpdateDTO.icu_menstrual_cycle_perm;
    ...
    garmin_power_target?: AthleteUpdateDTO.garmin_power_target;
    ...
    height?: number;
    height_units?: AthleteUpdateDTO.height_units;
    plan?: AthleteUpdateDTO.plan;
    plan_expires?: string;
...
export namespace AthleteUpdateDTO {
